...
public interface BeanGenerationContext {
    ClassModel getReadOnlyBeanInterface(@NotNull Entity entity);
    ClassModel getMutableBeanInterface(@NotNull Entity entity);
    ClassModel getMutableBeanImplementationClass(@NotNull Entity entity);
}
