...
public class All {
    ...
    public enum ClassKind {
        ...
        private ClassKind(@NotNull String representation) {
            this.representation = representation;
        }
    ...
    public interface MemberModel extends AnnotatedModel, NamedModel, DataHolder {
        @NotNull
    ...
    public interface ClassModel extends MemberModel {
        ...
        @NotNull
        List<TypeModel> getSuperInterfaces();
